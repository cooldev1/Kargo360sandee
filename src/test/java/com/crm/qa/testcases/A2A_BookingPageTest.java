...
public class A2A_BookingPageTest  extends TestBase {

	LoginPage loginPage;
	HomePage homePage;
	TestUtil testUtil;
	TestBase TestBase;
	com.crm.qa.pages.A2A_Booking_Page A2A_Booking_Page;
			
	public A2A_BookingPageTest(){
		super();
		}
	...
	public void setUp() throws InterruptedException {
		...
		A2A_Booking_Page = new com.crm.qa.pages.A2A_Booking_Page();
	}
	...
	@Test(priority=2)
	public void verifyA2A_Booking_gpage() throws InterruptedException{
		homePage.verifyHomePageurl();
	...
	@Test(priority=3)
	public void A2A_Prepaid_one_Lag_flow() throws InterruptedException, IOException{
		homePage.verifyHomePageurl();
		A2A_Booking_Page.ClickOnNew_order_AWB();
		Thread.sleep(2000);
		Assert.assertEquals(driver.getCurrentUrl(),prop.getProperty("url")+ "/create-booking");
...
//To Save Booking
 ...
 //To Accpet the AWB
	...
	@Test(priority=4)
	public void A2ABooking_Prepaid_Gen_Single_Lag_flow() throws InterruptedException, IOException{
		homePage.verifyHomePageurl();
		A2A_Booking_Page.ClickOnNew_order_AWB();
		Thread.sleep(2000);
		Assert.assertEquals(driver.getCurrentUrl(),prop.getProperty("url")+ "/create-booking");
...
//To Save Booking
 ...
 //To Accpet the AWB
	...
	@Test(priority=5)
	public void A2ABooking_Po_Mail_S_Single_lag_flow() throws InterruptedException, IOException{
		homePage.verifyHomePageurl();
		A2A_Booking_Page.ClickOnNew_order_AWB();
		Thread.sleep(2000);
		Assert.assertEquals(driver.getCurrentUrl(),prop.getProperty("url")+ "/create-booking");
...
//To Save Booking
 ...
 //To Accpet the AWB
	...
	@Test(priority=6)
	public void A2ABooking_Walking_Single_Lag_flow() throws InterruptedException, IOException{
		homePage.verifyHomePageurl();
		A2A_Booking_Page.ClickOnNew_order_AWB();
		Thread.sleep(2000);
		Assert.assertEquals(driver.getCurrentUrl(),prop.getProperty("url")+ "/create-booking");
...
//				         String newText1 = parts1[1]; // Access the part after "is"
	...
	@Test(priority=7)
	public void A2A_Prepaid_Double_leg_Gen_flow() throws InterruptedException, IOException{
		homePage.verifyHomePageurl();
		A2A_Booking_Page.ClickOnNew_order_AWB();
		Thread.sleep(2000);
		Assert.assertEquals(driver.getCurrentUrl(),prop.getProperty("url")+ "/create-booking");
...
//To Save Booking
 ...
 //To Accpet the AWB
	...
	@Test(priority=8)
	public void A2A_Prepaid_Double_leg_PoMail_flow() throws InterruptedException, IOException{
		homePage.verifyHomePageurl();
		A2A_Booking_Page.ClickOnNew_order_AWB();
		Thread.sleep(2000);
		Assert.assertEquals(driver.getCurrentUrl(),prop.getProperty("url")+ "/create-booking");
...
//To Save Booking
 ...
 //To Accpet the AWB
	...
	@Test(priority=9)
	public void A2A_Prepaid_Double_leg_Walking_flow() throws InterruptedException, IOException{
		homePage.verifyHomePageurl();
		A2A_Booking_Page.ClickOnNew_order_AWB();
		Thread.sleep(2000);
		Assert.assertEquals(driver.getCurrentUrl(),prop.getProperty("url")+ "/create-booking");
...
//		         String newText1 = parts1[1]; // Access the part after "is"
	...
	@Test(priority=10)
	public void A2A_Prepaid_Triple_leg_Gen_flow() throws InterruptedException, IOException{
		homePage.verifyHomePageurl();
		A2A_Booking_Page.ClickOnNew_order_AWB();
		Thread.sleep(2000);
		Assert.assertEquals(driver.getCurrentUrl(),prop.getProperty("url")+ "/create-booking");
...
//To Save Booking
 ...
 //To Accpet the AWB
	...
	@Test(priority=11)
	public void A2A_Prepaid_Third_leg_POMail_flow() throws InterruptedException, IOException{
		homePage.verifyHomePageurl();
		A2A_Booking_Page.ClickOnNew_order_AWB();
		Thread.sleep(2000);
		Assert.assertEquals(driver.getCurrentUrl(),prop.getProperty("url")+ "/create-booking");
...
//-----------To Select Third leg Flight	
	...
	//Select Route Destination
				//  String des  =  sheet.getRow(i).getCell(3).getStringCellValue();
				  driver.findElement(By.xpath("//*[contains(@class,'table datatable-basic dataTable datatable-scroll no-footer route_dv ng-tns')]//child::tbody//child::tr[3]//child::td[3]//input")).sendKeys(des);
				 driver.findElement(By.xpath("//*[contains(@class,'table datatable-basic dataTable datatable-scroll no-footer route_dv ng-tns')]//child::tbody//child::tr[3]//child::td[3]//input")).sendKeys(Keys.ARROW_DOWN,Keys.ENTER);
...
//To Save Booking
 ...
 //To Accpet the AWB
	...
	@Test(priority=12)
	public void A2A_Prepaid_Triple_leg_WLK_flow() throws InterruptedException, IOException{
		homePage.verifyHomePageurl();
		A2A_Booking_Page.ClickOnNew_order_AWB();
		Thread.sleep(2000);
		Assert.assertEquals(driver.getCurrentUrl(),prop.getProperty("url")+ "/create-booking");
